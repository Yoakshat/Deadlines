    ...
    <main style={{ maxWidth: 420, margin: '2rem auto', padding: '0 1rem', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: '1.5rem' }}>
        <input
          ...
          style={{
            flex: 1, height: 36, padding: '0 12px', border: '0.5px solid #ccc',
        ...
        <button
          ...
          disabled={adding}
          style={{
            height: 36, padding: '0 16px', border: '0.5px solid #ccc',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {classes.map((cls, i) => (
            <div key={cls.id} style={{
              ...
              padding: '12px 16px', background: 'white', border: '0.5px solid #eee',
              borderRadius: 12
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: '#aaa', marginTop: 2 }}>
                    {cls.last_checked
                      ? `last checked ${formatDate(cls.last_checked)}`
                      : 'will check tomorrow'}
                  </div>
                </div>
              </div>
              <button
                ...
                style={{
                  ...
                  color: '#bbb', fontSize: 18, cursor: 'pointer', borderRadius: 6,
